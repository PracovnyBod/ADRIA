...
\def\oznacenieCasti{AR01 - LS2019}
...
\begin{figure}[!ht]
	\centering
	\makebox[\textwidth][c]{\includegraphics{fig/cv00_fig_1.pdf}}
...
\begin{figure}[t]
	\centering
	\makebox[\textwidth][c]{\includegraphics{fig/cv00_fig_2.pdf}}
...
\begin{figure}[t]
	\centering
	\makebox[\textwidth][c]{\includegraphics{fig/cv00_fig_3.pdf}}
...
V ideálnom prípade, keď poznáme parameter $a$,~vieme určiť  pre zákon riadenia \uv{ideálne} $k^*$:
