...
\def\oznacenieCasti{AR05 - LS2026}
...
\begin{enumerate}[leftmargin=0pt, labelsep=4mm, itemsep=0pt]
    ...
    \begin{enumerate}
    	...
    	\item Navrhnite priamy adaptívny stavový regulátor pre zadaný systém, ktorý zabezpečí, že stavové veličiny URO asymptoticky sledujú stavové veličiny referenčného modelu a zároveň celý adaptívny uzavretý riadiaci obvod je stabilný.
    \end{enumerate}
