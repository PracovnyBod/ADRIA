...
ax0.plot(t_log_rec, x_log_rec[0][:,0],
         '-', lw=0.75, color='k',
         label = u'$a={}$'.format(testPripady['pripad1'])
         )

ax0.plot(t_log_rec, x_log_rec[1][:,0],
         '-', lw=0.75, color='k', dashes=[5,2],
         label = u'$a={}$'.format(testPripady['pripad2'])
         )

ax0.plot(t_log_rec, x_log_rec[2][:,0],
         '-', lw=0.75, color='k', dashes=[2,2],
         label = u'$a={}$'.format(testPripady['pripad3'])
         )
...
ax1.plot(t_log_rec, -x_log_rec[0][:,1]*x_log_rec[0][:,0],
         '-', lw=0.75, color='k',
         )

ax1.plot(t_log_rec, -x_log_rec[1][:,1]*x_log_rec[1][:,0],
         '-', lw=0.75, color='k', dashes=[5,2],
         )

ax1.plot(t_log_rec, -x_log_rec[2][:,1]*x_log_rec[2][:,0],
         '-', lw=0.75, color='k', dashes=[2,2],
         )
...
ax2.plot(t_log_rec, x_log_rec[0][:,1],
         '-', lw=0.75, color='k',
         )

ax2.plot(t_log_rec, x_log_rec[1][:,1],
         '-', lw=0.75, color='k', dashes=[5,2],
         )

ax2.plot(t_log_rec, x_log_rec[2][:,1],
         '-', lw=0.75, color='k', dashes=[2,2],
         )
