...
figNamePrefix = 'fig_tex_04_'

figPlotParam = fcnDefaultFigSize(7.5, 0.11, 0.92, 0.1, 0.5, 13)
...
ax1.set_ylabel(u'[°]', y=1.0, ha='right', va='top', rotation='horizontal', )

ax1.plot(t_log, (y_log[:, 0] - x_m_log[:, 0]) * (180/np.pi),
         '-k', lw=1.0,
         label=u'$e(t)$',
         )
